...
public class TFCOreDictCleaner {

    private static final Set<String> BLOCKED_MODS = new HashSet<>(Arrays.asList("tfc"));
    private static final Set<String> BLOCKED_ORES = new HashSet<>(Arrays.asList(
            ...
            "gemLignite", "gemCoal", "dustCharcoal", "dyeBlack", "gemCinnabar"
    ));
